#ifndef SMALLCARDSCENE_H
#define SMALLCARDSCENE_H
...
class SmallCardScene : public QGraphicsScene
{
    Q_OBJECT
public:
    explicit SmallCardScene(QObject *parent = 0);
    float picSize;
